...
namespace DataAccess.Migrations
{
    ...
    [Migration("20250111120829_building_database_temp")]
    partial class building_database_temp
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Models.CourseInstructor", b =>
                {
                    ...
                    b.HasKey("CourseId", "InstructorId", "InstructorStatus");

                    b.HasIndex("InstructorId", "InstructorStatus");
            ...
            modelBuilder.Entity("Models.CourseInstructor", b =>
                {
                    ...
                    b.HasOne("Models.Instructor", "Instructor")
                        .WithMany()
                        .HasForeignKey("InstructorId", "InstructorStatus")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
